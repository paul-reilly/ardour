 ...
 */
class LIBARDOUR_API VST3PI : public Vst::IComponentHandler, public Vst::IConnectionPoint
{
public:
	...
	uint32_t    designated_bypass_port () const { return _bypass_port_id; }
